...
if is_g2pw:
    ...
    from third_party.text.g2pw import G2PWPinyin, correct_pronunciation

    parent_directory = os.path.dirname(current_file_path)
    g2pw = G2PWPinyin(
        model_dir="GPT_SoVITS/text/G2PWModel",
        model_source=os.environ.get("bert_path", "hfl/chinese-roberta-wwm-ext-large"),
        v_to_u=False,
    ...
    for seg in segments:
        ...
        for c, v in zip(initials, finals):
            ...
            if c == v:
                ...
                if tone != '5':
                    full_pinyin.append(pinyin + tone)
                else:
                    full_pinyin.append(pinyin)
